        ...
        1: [function(b, c, d) {
            !function(b, e) {
                ...
                , function(a, b, c) {
                    ...
                    var p, q, r = c(0), s = /(\d|-|\.)/, t = /([^\-0-9.]+)/g, u = /[0-9.-]+/g, v = (p = u.source,
                    q = /,\s*/.source,
                    new RegExp("rgb\\(".concat(p).concat(q).concat(p).concat(q).concat(p, "\\)"),"g")), w = /^.*\(/, x = /#([0-9]|[a-f]){3,6}/gi, y = function(a, b) {
                        ...
                        return N._applyFilter("afterTween"),
                        j
                    }, Q = function() {
                        function a() {
                            !function(a, b) {
