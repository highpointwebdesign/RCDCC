...
;(function () {
    ...
    var _defaults = {
        ...
        sounds: {
            ...
            info: "./assets/plugins/toasty/dist/sounds/info/2.mp3",
            // path to sound for successfull message:
            success: "./assets/plugins/toasty/dist/sounds/success/3.mp3",
            // path to sound for warn message:
            warning: "./assets/plugins/toasty/dist/sounds/warning/3.mp3",
            // path to sound for error message:
            error: "./assets/plugins/toasty/dist/sounds/error/3.mp3",
        },
