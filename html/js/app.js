window.onerror = function (msg, url, line) {
    console.log("JS ERROR:", msg, "Line:", line);
        ...
        function testNotification(type) {
            ...
            const messages = {
                success: 'Testing success notification flash (green)',
                error: 'Testing error notification flash (red)',
                warning: 'Testing warning notification flash (amber)',
                info: 'Testing info notification flash (blue)'
            };
        ...
        const LIGHT_GROUP_EXTRA_PATTERNS = ['Steady', 'Double Flash', 'Strobe', 'Breathe', 'Flicker', 'Cycle'];
        ...
        function renderColorPresets() {
            ...
            colorPresets.forEach((color, index) => {
                ...
                colorBtn.title = `Use ${color}`;
                colorBtn.onclick = () => setLightGroupColor(color);
        ...
        // Update a specific preset slot with the current color
        function updateColorPreset(index) {
            colorPresets[index] = currentColor;
            saveColorPresets();
            window.toast.success(`Preset ${index + 1} updated to ${currentColor.toUpperCase()}`);
        }
        ...
        function renderLightGroupsList() {
            ...
            if (lightGroups.length === 0) {
                ...
                sortedGroups.forEach((group) => {
                    const index = lightGroups.findIndex(g => g === group);
                    ...
                    const patternDisplay = pattern === 'Cycle'
        ...
        let currentBrightness = 100; // Default 100% (255 in 0-255 scale)
        ...
        function openLightGroupModal(index = null) {
            ...
            if (index !== null) {
                ...
                if (lightGroupBrightnessSliderInstance) {
                    lightGroupBrightnessSliderInstance.value([0, 100]);
                }
                updateLightGroupBrightnessThumbLabel(100);
        ...
        function saveLightGroupFromModal() {
            ...
            if (currentSelectedLEDs.size === 0) {
                alert('Please select at least one LED');
                return;
            }
        ...
        function setLightGroupColor(color) {
            currentColor = color;
            const colorPicker = document.getElementById('lightGroupColorPicker');
            const colorHex = document.getElementById('lightGroupColorHex');
        ...
        const servoSliderInstances = {
            frontLeft: { rangeElement: null, trimElement: null, rangeInstance: null, trimInstance: null, lastRangeValue: [0, 0] },
            frontRight: { rangeElement: null, trimElement: null, rangeInstance: null, trimInstance: null, lastRangeValue: [0, 0] },
            rearLeft: { rangeElement: null, trimElement: null, rangeInstance: null, trimInstance: null, lastRangeValue: [0, 0] },
            rearRight: { rangeElement: null, trimElement: null, rangeInstance: null, trimInstance: null, lastRangeValue: [0, 0] }
        };
                        ...
                        if (!isLoadingTuningConfig && !servoRangeLocked) {
                            ...
                            servoSliderSaveTimers.frontLeft.range = setTimeout(() => {
                                ...
                                if (value[0] !== lastValue[0]) {
                                    saveServoParameter('frontLeft', 'min', value[0]);
                                }
                                if (value[1] !== lastValue[1]) {
                                    saveServoParameter('frontLeft', 'max', value[1]);
                                }
                    ...
                    onInput: function(value) {
                        ...
                        if (!isLoadingTuningConfig && !servoRangeLocked) {
                            ...
                            servoSliderSaveTimers.frontRight.range = setTimeout(() => {
                                ...
                                if (value[0] !== lastValue[0]) {
                                    saveServoParameter('frontRight', 'min', value[0]);
                                }
                                if (value[1] !== lastValue[1]) {
                                    saveServoParameter('frontRight', 'max', value[1]);
                                }
                    ...
                    onInput: function(value) {
                        ...
                        if (!isLoadingTuningConfig && !servoRangeLocked) {
                            ...
                            servoSliderSaveTimers.rearLeft.range = setTimeout(() => {
                                ...
                                if (value[0] !== lastValue[0]) {
                                    saveServoParameter('rearLeft', 'min', value[0]);
                                }
                                if (value[1] !== lastValue[1]) {
                                    saveServoParameter('rearLeft', 'max', value[1]);
                                }
                    ...
                    onInput: function(value) {
                        ...
                        if (!isLoadingTuningConfig && !servoRangeLocked) {
                            ...
                            servoSliderSaveTimers.rearRight.range = setTimeout(() => {
                                ...
                                if (value[0] !== lastValue[0]) {
                                    saveServoParameter('rearRight', 'min', value[0]);
                                }
                                if (value[1] !== lastValue[1]) {
                                    saveServoParameter('rearRight', 'max', value[1]);
                                }
